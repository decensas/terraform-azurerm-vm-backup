...
| <a name="input_immutability"></a> [immutability](#input\_immutability) | Whether you want vault to be immutable. Review https://learn.microsoft.com/en-us/azure/backup/backup-azure-immutable-vault-concept?tabs=recovery-services-vault | `bool` | `false` | no |
